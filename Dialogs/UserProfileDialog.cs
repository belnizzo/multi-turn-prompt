    ...
    public class UserProfileDialog : ComponentDialog
    {
        ...
        private static async Task<DialogTurnResult> PizzaTypeStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            return await stepContext.PromptAsync(nameof(ChoicePrompt),
                new PromptOptions
                {
                    Prompt = MessageFactory.Text("Hello, Please enter your preffered Pizza flavor"),
                    Choices = ChoiceFactory.ToChoices(new List<string> {"Pepperoni", "Hawaiian", "Margherita","BBQ Chicken","Boerewors" }),
                }, cancellationToken);
        }

        private static async Task<DialogTurnResult> NameStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            stepContext.Values["pizza"] = ((FoundChoice)stepContext.Result).Value;
        ...
        private async Task<DialogTurnResult> SummaryStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            if ((bool)stepContext.Result)
            {
                ...
                userProfile.PizzaType = (string)stepContext.Values["pizza"];
                userProfile.Name = (string)stepContext.Values["name"];
                userProfile.Age = (int)stepContext.Values["age"];
                userProfile.Picture = (Attachment)stepContext.Values["picture"];

                var msg = $"I have your preferred pizza flavour is {userProfile.PizzaType} and your name as {userProfile.Name}";
